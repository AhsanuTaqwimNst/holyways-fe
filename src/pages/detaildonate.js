...
function DetailDonate() {
  ...
  useEffect(() => {
    ...
    const myMidtransClientKey = "SB-Mid-client-VSc2WLYu8R6S3nlW";
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="col-lg-12  row  justify-content-start ">
            ...
            <h3
              className="font-weight-bold mt-4 col-lg-10"
              onClick={handleProfile}
            >
              List Donation ( {transaction?.length} )
            </h3>
          </div>
            ...
            <div className="modal-body ">
              <Form action="#" className="row ml-2 mr-2">
                <div className="form-group w-100">
                  <input
                    type="number"
                    value={donateamount} // brp donasinya
                    name="donateamount"
                    onChange={handleChange}
                    className="form-control w-100"
                    placeholder="Nominal Donate"
                  ></input>
